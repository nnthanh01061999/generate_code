            ...
            <div className="permission_denied">
                <div className="denied__wrapper">
                    ...
                    <svg id="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        />
                        <path
                            d="M346.4 470H165l5 5V248.5c0-10.3 3.9-20.3 15-23.3 6.4-1.8 14.2-.7 20.7-.7h112.4c3.3 0 6.5 0 9.7 1.1 8.3 2.9 13.5 10.7 13.7 19.3.1 4.1 0 8.3 0 12.5v217.7c0 6.4 10 6.4 10 0V246.5c-.1-13.8-7.6-26-21-30.5-7.2-2.4-15.8-1.5-23.3-1.5H192.9c-14.8 0-28.7 8.4-32 23.6-1.1 5.2-.8 10.8-.8 16.1V475c0 2.7 2.3 5 5 5h181.4c6.3 0 6.3-10-.1-10z"
                            className="st1"
                        />
                        ...
                        />
                        <path
                            d="M181.6 111.8c-4.1 7.1-7.1 14.7-8.6 22.8-1.7 8.6 11.5 12.3 13.2 3.6 1.4-7 3.7-13.3 7.3-19.5 4.4-7.6-7.5-14.5-11.9-6.9zm.8 54.6c-.4-3-.5-6.5-.4-9.8.1-3.7-3.2-6.9-6.9-6.9-3.8 0-6.7 3.1-6.9 6.9-.2 4.5.2 8.9.9 13.4.5 3.7 5.2 5.7 8.4 4.8 4-1.1 5.4-4.8 4.9-8.4z"
                            className="st3"
                        />
                        <path
                        ...
                        />
                        <path d="m371.6 128.9 25.1-23.8" className="st13" />
                        ...
                        <path d="m139.7 128.9-25.1-23.8" className="st13" />
                        ...
                        <path
                            ...
                            className="st15"
                        />
                        <path d="M351.9 478.1H376M138 478.1h-18.3" className="st3" />
                        <path
                            d="M307.6 397.2h4.6c2.6 0 5.1-2.3 5-5-.1-2.7-2.2-5-5-5h-4.6c-2.6 0-5.1 2.3-5 5 .1 2.7 2.2 5 5 5zM199.2 397.2h4.6c2.6 0 5.1-2.3 5-5-.1-2.7-2.2-5-5-5h-4.6c-2.6 0-5.1 2.3-5 5 .1 2.7 2.2 5 5 5z"
                            className="st1"
                        />
                        <g className="st10">
                            <path
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <path
                            d="M109.388 285.56c42.515 1.428 157.943-2.613 289.462-73.807a150.243 150.243 0 0 0-23.322-45.604c-42.716 29.386-140.403 83.922-268.457 76.27a148.502 148.502 0 0 0 2.318 43.14zm291.346 8.027c3.976-15.31 5.422-30.68 4.614-45.672-33.75 25.31-137.237 92.367-277.65 84.876a150.107 150.107 0 0 0 23.472 29.88c44.354.286 137.696-6.443 245.93-57.163 1.362-3.89 2.58-7.86 3.634-11.92zM245.488 405.184c35.427 2.537 69.784-7.742 97.543-27.59-27.972 11.533-60.787 21.76-97.542 27.59zM348.02 138.097c-15.645-12.225-33.99-21.522-54.434-26.832-71.883-18.667-145.126 18.253-174.25 84.01 49.02-1.676 133.073-12.256 228.685-57.178z"
                            className="saturn-2"
                            fill="#EA4753"
                        />
                        <circle className="hover" cx={319.166} cy={208.081} r={28.389} fill="#D83A4E" />
                        <path
                            d="M331.25 189.492a28.248 28.248 0 0 1 14.792 9.452c-2.98-8.73-10.143-15.848-19.74-18.34-15.175-3.94-30.672 5.167-34.613 20.342-2.373 9.136-.012 18.384 5.55 25.162a28.261 28.261 0 0 1-.602-16.273c3.94-15.177 19.438-24.284 34.613-20.343z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={234.463} cy={273.978} r={19.358} fill="#D83A4E" />
                        <path
                            d="M242.703 261.303a19.273 19.273 0 0 1 10.085 6.444c-2.03-5.953-6.916-10.806-13.46-12.505-10.347-2.687-20.914 3.523-23.6 13.87-1.62 6.23-.008 12.537 3.785 17.158a19.265 19.265 0 0 1-.41-11.097c2.686-10.348 13.252-16.558 23.6-13.87z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={307.493} cy={144.207} r={12.584} fill="#D83A4E" />
                        <path
                            d="M312.85 135.967a12.522 12.522 0 0 1 6.557 4.19c-1.32-3.872-4.496-7.026-8.75-8.13-6.727-1.747-13.596 2.29-15.343 9.017a12.563 12.563 0 0 0 2.46 11.153 12.532 12.532 0 0 1-.267-7.213c1.747-6.727 8.616-10.764 15.343-9.017z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={163.289} cy={255.495} r={19.358} fill="#D83A4E" />
                        <path
                            d="M171.53 242.82a19.25 19.25 0 0 1 10.084 6.443c-2.03-5.954-6.916-10.806-13.46-12.505-10.348-2.687-20.915 3.523-23.602 13.87-1.618 6.23-.008 12.536 3.785 17.158a19.265 19.265 0 0 1-.41-11.097c2.687-10.348 13.255-16.558 23.602-13.87z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={230.586} cy={365.92} r={19.358} fill="#D83A4E" />
                        <path
                            d="M238.826 353.245a19.273 19.273 0 0 1 10.085 6.444c-2.03-5.954-6.915-10.807-13.46-12.506-10.347-2.688-20.914 3.522-23.6 13.87-1.62 6.23-.01 12.536 3.784 17.157a19.261 19.261 0 0 1-.41-11.096c2.688-10.346 13.255-16.556 23.602-13.87z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={302.221} cy={353.781} r={19.357} fill="#D83A4E" />
                        <path
                            d="M310.462 341.105a19.272 19.272 0 0 1 10.085 6.445c-2.03-5.954-6.916-10.807-13.46-12.506-10.348-2.688-20.914 3.523-23.602 13.87-1.618 6.23-.008 12.536 3.785 17.157a19.257 19.257 0 0 1-.41-11.095c2.687-10.346 13.254-16.556 23.602-13.87z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={358.827} cy={284.847} r={11.079} fill="#D83A4E" />
                        <path
                            d="M363.542 277.593a11.027 11.027 0 0 1 5.772 3.688 11.067 11.067 0 0 0-7.703-7.156c-5.922-1.537-11.97 2.017-13.507 7.938a11.062 11.062 0 0 0 2.166 9.82c-.676-1.98-.8-4.175-.235-6.352 1.537-5.92 7.585-9.475 13.507-7.937z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={220.465} cy={156.416} r={11.079} fill="#D83A4E" />
                        <path
                            d="M225.18 149.162a11.026 11.026 0 0 1 5.773 3.688 11.064 11.064 0 0 0-7.703-7.157c-5.922-1.538-11.97 2.016-13.508 7.938a11.061 11.061 0 0 0 2.167 9.82 11.02 11.02 0 0 1-.236-6.35c1.537-5.922 7.585-9.476 13.507-7.938z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={154.027} cy={171.743} r={5.819} fill="#D83A4E" />
                        <path d="M156.504 167.933a5.786 5.786 0 0 1 3.03 1.938 5.82 5.82 0 1 0-10.002 5.568 5.819 5.819 0 0 1 6.97-7.505z" opacity={0.1} />
                        <circle className="hover" cx={391.387} cy={251.305} r={5.819} fill="#D83A4E" />
                        <path
                            d="M393.864 247.495a5.786 5.786 0 0 1 3.03 1.937 5.813 5.813 0 0 0-4.045-3.76 5.822 5.822 0 0 0-7.096 4.17 5.813 5.813 0 0 0 1.138 5.158 5.819 5.819 0 0 1 6.971-7.506z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={145.077} cy={302.473} r={5.819} fill="#D83A4E" />
                        <path
                            d="M147.554 298.662a5.79 5.79 0 0 1 3.03 1.938 5.813 5.813 0 0 0-4.045-3.76 5.822 5.822 0 0 0-7.096 4.17 5.809 5.809 0 0 0 1.138 5.157 5.794 5.794 0 0 1-.124-3.335 5.822 5.822 0 0 1 7.096-4.17z"
                            opacity={0.1}
                        />
                        <circle className="hover" cx={187.342} cy={355.265} r={5.819} fill="#D83A4E" />
                        <path d="M189.818 351.455a5.787 5.787 0 0 1 3.032 1.938 5.82 5.82 0 1 0-10.004 5.567 5.82 5.82 0 0 1 6.971-7.506z" opacity={0.1} />
                        <path
                        ...
                        <path
                            className="stars"
                            fill="#FFF"
                            d="M112.456 363.093c-.056 7.866-6.478 14.197-14.344 14.142 7.866.056 14.198 6.48 14.142 14.345.056-7.866 6.48-14.198 14.345-14.142-7.868-.057-14.2-6.48-14.144-14.345zm319.98-88.185c-.056 7.866-6.478 14.198-14.344 14.142 7.866.057 14.197 6.48 14.142 14.345.056-7.866 6.48-14.197 14.345-14.142-7.868-.056-14.2-6.48-14.144-14.345zM159.75 58.352c-.12 16.537-13.62 29.848-30.157 29.73 16.537.118 29.848 13.62 29.73 30.156.118-16.537 13.62-29.848 30.156-29.73-16.54-.117-29.85-13.62-29.73-30.156z"
                        />
                    </svg>

                    <button className="denied__link">
